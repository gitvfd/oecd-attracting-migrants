function loopOverIndicators(){
	...
	pearlchart("Workers", document.getElementById("country_dropdown").options[document.getElementById("country_dropdown").selectedIndex].value, document.getElementById("country_dropdown_comp").options[document.getElementById("country_dropdown_comp").selectedIndex].value, data.filter(function (d) { return d.Cat == "Workers" }))
	pearlchart("Entrepreneurs", document.getElementById("country_dropdown").options[document.getElementById("country_dropdown").selectedIndex].value, document.getElementById("country_dropdown_comp").options[document.getElementById("country_dropdown_comp").selectedIndex].value,data.filter(function(d){return d.Cat=="Entrepreneurs"}))
	pearlchart("Student", document.getElementById("country_dropdown").options[document.getElementById("country_dropdown").selectedIndex].value, document.getElementById("country_dropdown_comp").options[document.getElementById("country_dropdown_comp").selectedIndex].value,data.filter(function(d){return d.Cat=="Student"}))
	
}

function pearlchart(nameIndic, selectedCou,compCou,indicData){

	var indicData = indicData.filter(function (d) { return d.value != "NA" })

	var rankArray = []
	indicData.filter(function (k) { return k.variable == "Total" }).forEach(function (k) {
		if (k.value != "NA")
